...
Manual_Adjustment_Reduce
   ...
   [Documentation]    Creation of a monthly loan
    ...
    Wait Until Keyword Succeeds    30s    5s    Wait Until Page Contains Element    //*[@script-id="AADETAILSNEWACTIVITIES_DRILLDOWN_R42_1"]
    Sleep    1s
    Click Element   //*[@script-id="AADETAILSNEWACTIVITIES_DRILLDOWN_R42_1"]
    Sleep    1s
    # ${handles}    Get Window Handles
...
Manual_Adjustment_Remove
   ...
   [Documentation]    Creation of a monthly loan
    ...
    Sleep   5s
    Input Text    //*[@name="C1__C3__C1__C1__C1__C1__C1__C1__VERAAARRBALANCEMAINTENANCE_AABILLS[1].VERAAARRBALANCEMAINTENANCE_AABILLS_BILLREFMVGROUP[1].ELEMENT[1].BILLADJNARR"]    test
    Input Text    //*[@name="C1__C3__C1__C1__C1__C1__C1__C1__VERAAARRBALANCEMAINTENANCE_AABILLS[1].VERAAARRBALANCEMAINTENANCE_AABILLS_BILLREFMVGROUP[1].ELEMENT[1].VERAAARRBALANCEMAINTENANCE_AABILLS_PROPERTYSVGROUP[1].ELEMENT[1].NEWPROPAMT"]    0
    Sleep    5s
    Click Element   (//*[@id="C1__validate_version_button"])[1]
    Wait Until Keyword Succeeds    30s    5s    Wait Until Page Contains Element    //*[@class="fixedPopUpInfodiv fixedPopUpInfodivPosition errorShadow tc-popup show-popup tc-popup-sticky acceptOverridesDialog ui-draggable"]
    Sleep    1s
