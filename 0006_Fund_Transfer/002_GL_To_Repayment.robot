...
GL_To_Repayment
   ...
   [Documentation]    Creation of a monthly loan
    ...
    Input Text    //*[@name="C1__C2__C1__C1__C1__VERFUNDSTRANSFER[1].DEBITACCTNO"]    SGD100110001
    ...
    Input Text    //*[@name="C1__C2__C1__C1__C1__VERFUNDSTRANSFER[1].CREDITACCTNO"]    1000009055
    Input Text    //*[@name="C1__C2__C1__C1__C1__VERFUNDSTRANSFER[1].CREDITCURRENCY"]    SGD
    Input Text    //*[@name="C1__C2__C1__C1__C1__VERFUNDSTRANSFER[1].VERFUNDSTRANSFER_ORDERINGBANKMVGROUP[1].ELEMENT[1].ORDERINGBANK"]    Capital C
    Sleep    0.5s
