...
Experiment_Test
   ...
   [Documentation]    Creation of a monthly loan
    ...
    Wait Until Page Contains Element    //*[@title="Show/Hide Menu"]
    # Click Element    //*[contains(text(),'User Menu')]
    Click Element    //*[@title="Show/Hide Menu"]
    Sleep    0.5s
    Wait Until Page Contains Element    //*[contains(text(),'User Menu')]
    ...
    ${arrangementID}=    Get Text    //*[@id="C1__C2__C1__C1__C1__QUE_--AA-ARRANGEMENT-ACTIVITY--ARRANGEMENT--"]
    Log To Console    this is the arrangement id
    ...
    # Sleep    20s
    Wait Until Keyword Succeeds    30s    5s    Wait Until Page Contains Element    //*[@id="C1__p4_accept_version_overrides_button"]
    Wait Until Keyword Succeeds    30s    5s    Click Element    //*[@id="C1__p4_accept_version_overrides_button"]
