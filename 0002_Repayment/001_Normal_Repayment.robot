...
Repayment_No_Excess
   ...
   [Documentation]    Creation of a monthly loan
    ...
    Sleep    1s
    Input Text    //*[@id="C1__C2__C1__C1__C1__QUE_--FUNDS-TRANSFER--CREDIT-ACCT-NO--"]    1000002948
    ...
    Input Text    (//*[@name='C1__C1__C1__C1__C1__ENQAAFINDARRANGEMENTAL[1].SEARCHREQUEST[1].FILTERS[1].ARRANGEMENTID[1].OPERAND1'])[1]    1000002948
    Sleep    1s
